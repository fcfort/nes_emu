...
public enum Opcode {
  ...
  private static class OpcodeBehavior {
    private static final ImmutableSet<String> MEMORY_READING_OPCODES =
        ImmutableSet.of(
            "ADC", "AND", "ASL", "BCC", "BCS", "BEQ", "BIT", "BMI", "BNE", "BPL", "BVC", "BVS",
            "CMP", "CPX", "CPY", "DEC", "EOR", "INC", "JMP", "JSR", "LDA", "LDX", "LDY", "LSR",
            "ORA", "ROL", "ROR", "SBC");
  }
  ...
  private static final int OPCODE_NUMBER_BASE = 16;
  ...
  Opcode(
      String opcodeBytes, String codeName, int cycles, int length, AddressingMode addressingMode) {
  ...
  Opcode(
      ...
      int cycles,
      int length,
      boolean extraCycleOnBranch,
      boolean extraCycleOnPageJump,
  ...
  public String toString() {
    return String.format(
        "Opcode[%s,%s,%s]",
        this.name(), HexUtils.toHex(this.getOpcodeBytes()), this.addressingMode);
  }
}
